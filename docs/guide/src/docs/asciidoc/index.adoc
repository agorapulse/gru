...
[source,java,indent=0,role="primary",subs='verbatim,attributes']
.Using @Inject with @MicronautTest (Java)
----
...
[source,kotlin,indent=0,role="secondary",subs='verbatim,attributes']
.Using Injected Instance with @MicronautTest (Kotlin)
----
...
[source,groovy,indent=0,role="secondary",subs='verbatim,attributes']
.Using @Inject with @MicronautTest (Groovy)
----
...
[source,java,indent=0,role="primary",subs='verbatim,attributes']
.Using Default Application Context (Java)
----
...
[source,kotlin,indent=0,role="secondary",subs='verbatim,attributes']
.Using Default Application Context (Kotlin)
----
...
[source,groovy,indent=0,role="secondary",subs='verbatim,attributes']
.Using Default Application Context (Groovy)
----
...
[source,java,indent=0,role="primary",subs='verbatim,attributes']
.Using a Custom Application Context (Java)
----
...
[source,groovy,indent=0,role="secondary",subs='verbatim,attributes']
.Using a Custom Application Context (Groovy)
----
...
[source,java,indent=0,role="primary",subs='verbatim,attributes']
.Creating a Custom Application Context (Java)
----
...
.Creating a Custom Application Context (Groovy)
[source,groovy,indent=0,role="secondary",subs='verbatim,attributes']
----
