...
dependencies {
    ...
    testCompile "com.agorapulse:gru-spring-integration-testing:{project-version}"       // <4>
    testCompile "com.agorapulse:gru-api-gateway:{project-version}"                      // <5>
    testCompile "com.agorapulse:gru-micronaut:{project-version}"                        // <6>
}
----
...
<4> Spring module for real HTTP calls in integration tests
<5> AWS API Gateway module for HTTP proxy lambdas
<6> Micronaut module for running HTTP request against the embedded server
