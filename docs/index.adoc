...
[source,groovy]
----
include::../gru-api-gateway-proxy/src/test/groovy/com/agorapulse/gru/agp/ApiGatewayConfigurationSpec.groovy[tag=simple]
----
...
[source,groovy]
----
include::../gru-api-gateway-proxy/src/test/groovy/com/agorapulse/gru/agp/ApiGatewayConfigurationSpec.groovy[tag=noproxy]
----
